...
- [Inbox Queue](https://github.com/Unity-Billal-mesloub/monaco-editor/issues?q=is%3Aissue+is%3Aopen+no%3Aassignee+-label%3Afeature-request+-label%3Aupstream+-label%3A%22info-needed%22++-label%3Abug+)

## Publishing a stable build monaco-editor build

- Trigger an rc-build
  - Go to https://github.com/Unity-Billal-mesloub/vscode/tree/release/1.89 (use latest VS Code version instead of .89!) and copy the id of the latest commit
...
- Update [package.json](https://github.com/Unity-Billal-mesloub/monaco-editor/blob/main/package.json)
...
- Update [CHANGELOG.md](https://github.com/Unity-Billal-mesloub/monaco-editor/blob/main/CHANGELOG.md)
...
- **TBD**
- https://github.com/Unity-Billal-mesloub/monaco-editor/tree/main/webpack-plugin
- `npm install .`
